...
train_data = open(
    "/home/linhw/qianweinan/Text Classification/data/train.txt",
    "r", encoding='utf-8'
).read()
dev_data = open(
    "/home/linhw/qianweinan/Text Classification/data/dev.txt",
    "r", encoding='utf-8'
).read()
test_data = open(
    "/home/linhw/qianweinan/Text Classification/data/test.txt",
    "r", encoding='utf-8'
).read()
...
embedding = nn.Embedding(len(dic),128)
train_feature = embedding(torch.LongTensor(train_coding))
dev_feature = embedding(torch.LongTensor(dev_coding))
test_feature = embedding(torch.LongTensor(test_coding))
